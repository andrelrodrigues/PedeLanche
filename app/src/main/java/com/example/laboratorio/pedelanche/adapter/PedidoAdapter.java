...
/**
 * Created by andrerodrigues on 21/06/17.
 */

public class PedidoAdapter extends ArrayAdapter<Produto> {

    NumberFormat formato = NumberFormat.getCurrencyInstance();

    public PedidoAdapter(Context context, ArrayList<Produto> item){
    ...
    public View getView(int position, View convertView, ViewGroup parent ){
        ...
        if (itemView == null) {
            //Infla o Layout
            itemView = LayoutInflater.from(getContext()).inflate(R.layout.item_pedido, parent, false);
        }
